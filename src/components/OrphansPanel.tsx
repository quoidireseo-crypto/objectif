...
export function OrphansPanel({ data, updateData, onChangeView }: OrphansPanelProps) {
  ...
  return (
    <div className="bg-white border border-amber-100 rounded-3xl shadow-sm overflow-hidden transition-all duration-300">
      {/* Panel Header */}
      <div 
      ...
      >
        <div className="flex items-center">
          ...
          <span className="font-sans font-bold text-stone-700 text-sm ml-2">Intentions en sommeil</span>
          <span className="bg-amber-100 text-amber-700 font-bold text-xs px-2 py-0.5 rounded-full ml-2">
      ...
      {isExpanded && (
        <div className="animate-in fade-in slide-in-from-top-2 duration-200">
          <p className="text-sm italic text-stone-500 px-5 pb-4 leading-relaxed">
